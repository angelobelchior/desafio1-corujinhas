...
namespace RestauranteSaborDoBrasil.Infra.Data.Context
{
    public class WritingDbContext : DbContext
    {
        ...
        public WritingDbContext(DbContextOptions<WritingDbContext> options, DbSettings dbSettings)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
                optionsBuilder.UseSqlServer(_dbSettings.WritingConnectionString);
